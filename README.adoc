...
| link:src/none/cgutils/algebraic/other/Example2VisitorPattern.java[Example1VisitorPattern]
| A walkthrough of the visitor pattern
| link:src/none/cgutils/algebraic/other/Example3Morphism.java[Example3Morphism]
| Homomorphism and Catamorphism
|===
